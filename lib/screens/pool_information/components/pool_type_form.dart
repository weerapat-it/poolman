...
class PoolTypeForm extends StatefulWidget {
  @override
  _PoolTypeFormState createState() => _PoolTypeFormState();
}

class _PoolTypeFormState extends State<PoolTypeForm> {
